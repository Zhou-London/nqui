		...
		<AriaTabList
			...
			className={composeRenderProps(className, (cls) =>
				cn(
					...
					"group-data-[variant=underline]/tabs:gap-5 group-data-[variant=underline]/tabs:border-border group-data-[variant=underline]/tabs:border-b group-data-[variant=underline]/tabs:orientation-vertical:border-r group-data-[variant=underline]/tabs:orientation-vertical:border-b-0",
					...
					"group-data-[variant=text]/tabs:gap-0.5",
					cls,
				),
			)}
		/>
		...
		<AriaTab
			...
			className={composeRenderProps(className, (cls) =>
				cn(
					...
					"group-data-[size=sm]/tabs:h-7 group-data-[size=md]/tabs:h-8 group-data-[size=lg]/tabs:h-9",
					// underline
					"group-data-[variant=underline]/tabs:-mb-px group-data-[variant=underline]/tabs:h-auto group-data-[variant=underline]/tabs:border-transparent group-data-[variant=underline]/tabs:border-b-2 group-data-[variant=underline]/tabs:px-0.5 group-data-[variant=underline]/tabs:pb-2.5 group-data-[variant=underline]/tabs:text-muted group-data-[variant=underline]/tabs:hover:text-foreground group-data-[variant=underline]/tabs:selected:border-foreground group-data-[variant=underline]/tabs:selected:text-foreground",
